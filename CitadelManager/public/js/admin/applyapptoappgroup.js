...
(function (Citadel) {
    var ApplyAppToAppGroup = (function () {
        ...
        ApplyAppToAppGroup.prototype.getRetrieveGroupData = function () {
            var _this = this;
            var ajaxSettings = {
                method: "GET",
                timeout: 60000,
        ...
        ApplyAppToAppGroup.prototype.getRetrieveData = function (blackFlag) {
            var _this = this;
        ...
        ApplyAppToAppGroup.prototype.onBlistClicked = function (e) {
            console.log("BlackListClicked");
            e.stopImmediatePropagation();
            e.stopPropagation();
            this.getRetrieveData(true);
        };
        ApplyAppToAppGroup.prototype.onWlistClicked = function (e) {
