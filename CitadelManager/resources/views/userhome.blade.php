...
<div class="fluent-menu" data-role="fluentmenu">
    <ul class="tabs-holder">
        <li id="btn_tab_time_restrictions" class="active">
            <a href="#tab_time_restrictions">Time Restrictions</a>
        </li>
        <li id="btn_tab_self_moderation">
            <a href="#tab_self_moderation">Self Moderation</a>
        </li>
        <li id="btn_tab_relaxed_policy">
            <a href="#tab_relaxed_policy">Relaxed Policy</a>
        </li>
    </ul>

    <!-- Primary menu contents container. -->
    <div class="tabs-content">
        <div class="tab-panel" id="tab_time_restrictions" style="display: block;">
            <!-- TODO: Notify user that changes are saved when they finish editing -->
            <!-- Last saved: blah-blah-blah --> <!-- Changes saved! -->

            <div>
                <div><!-- Time Restrictions entry -->
                    <input data-role="timepicker" data-seconds="false" data-show-labels="false" />
                    <input data-role="timepicker" data-seconds="false" data-show-labels="false" />

                    <input type="checkbox" data-role="checkbox" data-caption="Monday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Tuesday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Wednesday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Thursday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Friday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Saturday" />
                    <input type="checkbox" data-role="checkbox" data-caption="Sunday" />
                </div>
        ...
        <div class="tab-panel" id="tab_self_moderation" style="display: block;">
            <!-- TODO: Notify user that changes are saved when they finish editing -->

            <ul class="group-list">
                <li class="item"><span>bbc.com</span><span class="icon"><span class="mif-minus"></span></span></li>
                <li class="item"><span>npr.com</span><span class="icon"><span class="mif-minus"></span></span></li>
                <li class="item"><span>chiving.com</span><span class="icon"><span class="mif-minus"></span></span></li>
                <li class="item"><span>blah.com</span><span class="icon"><span class="mif-minus"></span></span></li>
                <li class="item"><span>xkcd.com</span><span class="icon"><span class="mif-minus"></span></span></li>
                <li class="item"><span>quora.com</span><span class="icon"><span class="mif-minus"></span></span></li>
            </ul>
        </div>

        <div class="tab-panel" id="tab_relaxed_policy" style="display: block;">
            <!-- TODO: Notify user that changes are saved when they finish editing -->
            
            <input type="checkbox" data-role="switch" data-caption="Enable Relaxed Policy Passcode" />

            <input type="password" data-role="input" data-clear-button="false" />
        </div>
