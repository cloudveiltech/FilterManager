    ...
    <div id="div_ea30_0">
        ...
        <div class="tabcontrol" data-role="tabcontrol">
            ...
            <ul class="tabs">
                ...
                <li>
                    <a href="#rule_selection_tab">Rule Selection</a>
                </li>
                <li>
            ...
            <div class="frames">
                ...
                <div class="frame" id="rule_selection_tab">
                    ...
                    <div class="info_div">
                        <p>
                            <span class="mif-filter fg-green"></span>&nbsp;&nbsp;&nbsp;Filtering rules. These match specific request strings.</p>
                        <p>
                            <span class="mif-language"></span>&nbsp;&nbsp;&nbsp;Natural Language Processing. These categories will cause a block action
                            when the text payload of a website is deemed to belong to selected categories.</p>
                        <p>
                            <span class="mif-warning fg-red"></span>&nbsp;&nbsp;&nbsp;Text triggers. These will cause blocking to happen if any of their content
                            is detected in any text payload. Use these sparingly, in fact you should probably only use triggers
                            for pornography.</p>
                    </div>
                ...
                <div class="frame" id="app_filtering_tab">
                    <div class="info_div">
                        <p>
                            ...
                            <br
                            /> Select whitelist if you want the listed apps to be excluded from filtering while all others
                            are filtered.
