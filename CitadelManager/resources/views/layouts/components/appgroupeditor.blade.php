            ...
            <form method="post" action="javascript:void(0)" id="editor_appgroup_form" data-on-submit="submit">
                ...
                <div class="row cell-auto-size" align="center">
                    ...
                    <div class="cell colspan1" id="apply_togroup_actions">
                        <br />
                        <div id="spiner">&nbsp;
                            <img id="spiner_1" src="{{asset('img/loading7_navy_blue.gif')}}" width="40px" />
                        </div>
                        <button class="button primary" type="button" id="apps_source_to_target"> &gt;&gt; </button>
                        <br />
                        <button class="button primary" type="button" id="app_source_to_target"> &gt; </button>
                        <br />
                        <button class="button primary" type="button" id="app_target_to_source"> &lt; </button>
                        <br />
                        <button class="button primary" type="button" id="apps_target_to_source"> &lt;&lt; </button>
                        <br />
                    </div>
