            ...
            <form method="post" action="javascript:void(0)" id="editor_application_form" data-on-submit="submit">
                ...
                <div class="row cell-auto-size">
                    <div class="cell cell-auto-size" style="margin-right: 20px">
                        <div class="input-control text app_editor_control" data-role="input">
                            ...
                            <button class="button helper-button clear app_editor_close_button" tabindex="-1" type="button">
                ...
                <div class="row">
                    ...
                    <div class="cell colspan1" id="editor_application_actions">
                        ...
                        <br />
                        <div id="spiner">&nbsp;
                            <img id="spiner_5" src="{{asset('img/loading7_navy_blue.gif')}}" width="40px" />
                        </div>
                        <button class="button primary" type="button" id="editor_application_right_all_btn"> &gt;&gt; </button>
                        <br />
                        <button class="button primary" type="button" id="editor_application_right_btn"> &gt; </button>
                        <br />
                        <button class="button primary" type="button" id="editor_application_left_btn"> &lt; </button>
                        <br />
                        <button class="button primary" type="button" id="editor_application_left_all_btn"> &lt;&lt; </button>
                        <br />
