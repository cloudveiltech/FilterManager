...
Vue.component('editable-span', {
    template: "<div class='editable-span'>\
		...
		<input name='editor' v-if='isEditing' type='text' @blur='doneEditing()' @keydown='onKeyDown' @input='onInput()' style='display: inline-block; margin-bottom: 0; margin-top: 0;'\
			class='form-control width-70-percent' v-model='innerValue' />\
		<select class='form-select width-25-percent' style='display: inline-block;' v-model='value.activation'>\
