...
<div class="bg-dark" id="overlay_apply_app_to_app_group">
    <div id="div_apply_app_to_app_group_0">
        <div class="flex-grid">
            <h1 id="apply_app_to_app_group_title">Apply Application to AppGroup</h1>
            <br/>
            <hr class="thin" />
            <br/>
            ...
            <div class="row">
                ...
                <div class="cell colspan1" id="apply_app_to_app_group_actions">
                    <br />
                    <div id="spiner">&nbsp;
                        <img id="spiner_2" src="{{asset('img/loading7_navy_blue.gif')}}" width="40px" />
                    </div>
                    <button class="button primary" type="button" id="apply_app_to_app_group_right_all_btn"> &gt;&gt; </button>
                    <br />
                    <button class="button primary" type="button" id="apply_app_to_app_group_right_btn"> &gt; </button>
                    <br />
                    <button class="button primary" type="button" id="apply_app_to_app_group_left_btn"> &lt; </button>
                    <br />
                    <button class="button primary" type="button" id="apply_app_to_app_group_left_all_btn"> &lt;&lt; </button>
                    <br />
